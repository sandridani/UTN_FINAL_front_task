        ...
        <section className="text-center mb-5" key={index}>
          ...
          <div className="row row-cols-1 row-cols-md-2 row-cols-xl-4 justify-content-center g-4">
            ...
            { tasks.filter(tasks => tasks.estado === categoria.toUpperCase())
               ////filtra las tareas segun el estado de las categorias
             .map(task => (       ///este es el id
               <div className="col" key={task.id}>
                <div className="card h-100">
                 ...
                 {/* footer de la tarjeta con "mas detalle"*/}
                  <div className="card-footer p-4 pt-0 border-top-0 bg-transparent">
                    <div className="text-center d-flex gap-1 aling-items-center justify-content-center">
                      <Link to={`/detalle/${task.id}`} className="btn btn-outline-secondary mt-auto"> Más </Link>
