...
const ModalAgregarTarea: React.FC<ModalAgregarTareaProps> = ({showModal, handleClose, createTask})=>{
    const validationSchema = Yup.object({
        ...
        tiempo: Yup.number().required('Este campo es obligatorio').integer('El tiempo debe estar en numeros').positive('El tiempo debe ser positivo'),
       ...
       const formik =useFormik({
        ...
        onSubmit: async (values)=>{
            values.estado.toUpperCase(); ///para convertir el estado en mayusculas
            console.log('Datos del formulario', JSON.stringify(values));

            await createTask(values); //llama a la funcion para cargar una tarea nueva
